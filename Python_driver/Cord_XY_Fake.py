...
class Cord_XY_Drive:
    def __init__(self,enable_pin,step_pin_l,dir_pin_l,step_pin_r,dir_pin_r,max_period,min_period,accel):
        self.enable_pin = 0#gpiozero.DigitalOutputDevice(enable_pin)
        self.dir_pin_l = 0#gpiozero.DigitalOutputDevice(dir_pin_l)
        self.step_pin_l = 0#gpiozero.DigitalOutputDevice(step_pin_l)
        self.dir_pin_r = 0#gpiozero.DigitalOutputDevice(dir_pin_r)
        self.step_pin_r = 0#gpiozero.DigitalOutputDevice(step_pin_r)
        self.dir_l = 0
        self.dir_r = 0
        self.steps_l = 0
        self.steps_r = 0
    ...
    def Start(self,Steps):
        ...
        pot_pause = pause
        time.sleep(self.max_period_h*Steps)
